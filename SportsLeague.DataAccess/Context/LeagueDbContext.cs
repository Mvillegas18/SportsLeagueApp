...

{
...

    {
...

        {
            ...
            .IsRequired(false);// Relación con Tournament (Cascade: eliminar torneo elimina partidos)
...

        {
            ...
            entity.Property(mr => mr.Observations).HasMaxLength(500); entity.Property(mr => mr.CreatedAt).IsRequired();
...

        {
            ...
            entity.Property(c => c.Type).IsRequired(); entity.Property(c => c.CreatedAt).IsRequired();
